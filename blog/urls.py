...
from .views import CategoryListView, CreateCategoryView, ArticleListView, ArticleCreateView, ArticleDetail, ArticleEditView, ArticleDeleteView

urlpatterns = [
    url(r'^$', CategoryListView.as_view(), name='article_category_list'),
    url(r'^create_category/$', CreateCategoryView.as_view(), name='category_create'),
